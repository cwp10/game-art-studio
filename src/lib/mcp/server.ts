  ...
  make_spritesheet: {
    ...
    properties: {
      ...
      segmentation: {
        ...
        description:
          "(선택) 프레임 분리 방식. 기본 components(연결요소). 팔·소품이 이웃 프레임과 닿아 " +
          "포즈가 한 덩어리로 붙을 때만 projection 을 쓴다 — 투영 프로파일 + DP 최소 절단으로 " +
          "기대 개수를 강제 분할한다. frameCount 가 맞다는 전제를 신뢰하므로 틀린 개수를 잡아주지 않는다.",
      },
      seamlessLoop: {
        type: "boolean",
        description:
