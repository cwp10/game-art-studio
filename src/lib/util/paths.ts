 ...
 */
// NEXT_IMAGEGEN_DATA_DIR is baked in at build time by next.config.ts.
// Override by setting IMAGEGEN_DATA_DIR before running pnpm build.
export const DATA_DIR = path.resolve(process.env.NEXT_IMAGEGEN_DATA_DIR!);
